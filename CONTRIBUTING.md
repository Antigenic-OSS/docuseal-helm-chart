...
This repository publishes an unofficial, community-maintained Helm chart for deploying DocuSeal in Kubernetes.
...
- Update `appVersion` when changing default upstream DocuSeal version.
...
- Avoid provider-specific assumptions without flags and docs.
